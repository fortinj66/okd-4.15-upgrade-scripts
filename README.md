This script updates the template and worker nodes to disable Secure Boot.  Secure Boot is the default on FCOS templates but not currently supported on SCOS.
